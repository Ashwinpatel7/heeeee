...
import { ArrowRight, ArrowLeft, Star, Heart, Sparkles, Send } from 'lucide-react';
        ...
        >
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="bg-gradient-to-r from-indigo-500/20 to-purple-500/20 rounded-2xl p-8 border border-indigo-400/30 relative overflow-hidden"
            >
              ...
              >
                ...
                {/* Heart that appears when plane reaches the end */}
                <motion.div
                  className="absolute"
